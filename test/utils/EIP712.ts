...
export default {
  async sign(order: IEVMOrderV2, account: string, verifyingContract: string): Promise<string> {
  ...
  createTypeData(
    ...
    primaryType: string,
    message: any,
    types: typeof TYPES_721 | typeof TYPES_1155 | typeof TYPES
  ): any {
    return {
      types: Object.assign(
        {
